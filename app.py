...
def show_distribution_section():
    ...
    # Блок с отрисовкой распределений числовых фичей
    ...
    # Блок с отрисовкой распределений кат. фичей
    ...
    # Блок с отрисовкой попарных распределений
...
def show_correlation_section():
    ...
    # Блок с подсчётом различных коэффициентов корреляции
...
def show_statistics_section():
    ...
    # Блок со статистиками для кат. фичей
